  ...
  export default {
    ...
    methods: {
      requestDatas: function () {
        ...
        this.$http.get(`/api/data/product/count/${this.input}`)
          .then(productCountResponse => {
            this.$http.get(`/api/data/product/name/${this.input}`)
              .then((productResponse) => {
                this.product_count = productCountResponse.data.count
        ...
        this.$http.get(`/api/data/account/${this.input}/count`)
          .then(accountCountResponse => {
            this.$http.get(`/api/data/account/${this.input}`)
              .then((accountResponse) => {
                this.account_count = accountCountResponse.data.count
        ...
        this.$http.get(`/api/data/lead/${this.input}/count`)
          .then(leadCountResponse => {
            this.$http.get(`/api/data/lead/${this.input}`)
              .then((leadResponse) => {
                this.lead_count = leadCountResponse.data.count
