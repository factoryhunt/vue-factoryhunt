      ...
      <div class="container">
        ...
        <div class="feature-item row">
          ...
          <div class="col-md-8 col-md-pull-4 scrollLeftDelay">
            <img class="img-responsive" src="../../../assets/for_supplier/feature-item-01.png" alt="download screen">
          </div>
        </div>
        <!--Feature item 02-->
        <div class="feature-item row">
        ...
        <div class="feature-item row">
          ...
          <div class="col-md-8 scrollRightDelay">
            <img class="img-responsive" src="../../../assets/for_supplier/feature-item-04.png" alt="download screen">
          </div>
        </div>
      </div>
    </div>
